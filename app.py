...
st.set_page_config(page_title="หัวใจก็เหงา หัวเข่าก็เสื่อม", page_icon="📊", layout="centered")
                   
st.title("หัวใจก็เหงา หัวเข่าก็เสื่อม")
...
- เข้มงวดเรื่องค่าติดลบ: ให้ตรวจสอบตัวเลขให้ดี หากตัวเลขใดมีเครื่องหมายด้านหน้า(ในบางครั้งอาจอยู่คนละบรรทัด) "-" ให้แปลงเป็นค่าติดลบในรูปแบบตัวเลขทางคอมพิวเตอร์เสมอ (เช่น -53.24 หรือ -12.43) **ห้ามเอาเครื่องหมายลบออกเด็ดขาด**
